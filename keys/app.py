...
app.config['MAIL_USERNAME'] = 'celso.gregorio@gmail.com'
app.config['MAIL_PASSWORD'] = 'wbun wucw eqzw zhlt'
app.config['MAIL_DEFAULT_SENDER'] = ('Suporte N1 - N2', 'your_email@gmail.com')
